...
function showFileList()
{
	...
	//计算当前页列表的结束位置
	document.getElementById('itemList').style.height = (48*fileReturnTotal+6)+"px";
	//显示页码和翻页指示
...
function showFileInfo()
{
	//移动焦点位置
	var pos = fileIndex%8;
	document.getElementById('itemFocus').style.top = 48*pos+"px";
	//获得项目图片显示数据
...
function channelSelect()
{
	...
	if (fileType[pos]!=0) {
		...
		setTimeout("makeRequest('play?'+fileRealName[fileIndex%8], hideWebPageRequest, 0)", 10);
